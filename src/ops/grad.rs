...
pub(crate) fn el_add_backward<T: Dtype>(
...
pub(crate) fn el_sub_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
    b: &Tensor<T>,
...
pub(crate) fn el_mul_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
    b: &Tensor<T>,
...
pub(crate) fn el_div_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
    b: &Tensor<T>,
...
pub(crate) fn el_max_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
    b: &Tensor<T>,
...
pub(crate) fn el_min_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
    b: &Tensor<T>,
...
pub(crate) fn reduce_sum_backward<T: Dtype>(
    mut grads: &mut HashMap<usize, Vec<T>>,
    t: &Tensor<T>,
    a: &Tensor<T>,
) {
